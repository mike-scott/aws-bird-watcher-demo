...
exec gst-launch-1.0 -e --gst-debug=2 \
	...
	qtimlvdetection name=stage_01_postproc threshold=65.0 stabilization=true results=10 module=yolo-nas constants="YoloV5,q-offsets=<3.0>,q-scales=<0.005047998391091824>;" labels="/opt/gst/yolonas.labels" \
